...
WEB_SETTINGS_HIDDEN_FROM_UI = {
    ...
    "PROXY_HOST",
    "PROXY_PORT",
    "BOLL_SCORE_V2_ENABLED",
    "INTRADAY_MONITOR_ENABLED",
    "INTRADAY_MONITOR_INTERVAL_SECONDS",
}
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "TUSHARE_API_URL": {
        ...
        "description": "Optional custom Tushare Pro API endpoint, for example a paid proxy gateway.",
        "category": "data_source",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "TUSHARE_REQUEST_INTERVAL": {
        ...
        "description": "Minimum seconds between Tushare Pro requests. Use 0.6 when the proxy provider requires throttling.",
        "category": "data_source",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "validation": {"min": 0},
        "display_order": 12,
        "help_key": "settings.data_source.TUSHARE_REQUEST_INTERVAL",
        "examples": [
